...
public class GreenwichMappings {
    ...
    private static final Map<String, String> messageMapping = Map.of(
            "Conditional", GreenwichMappings.Conditional_Offer,
            "Unconditional (Academically)", GreenwichMappings.Unconditional_Offer
    );



    public static String getAdventusDocumentMapping(String decision){
        return GreenwichMappings.getMapping(decisionMapping,decision);
    }

    public static String getAdventusOrderMapping(String decision){
        return GreenwichMappings.getMapping(orderTrackingMapping,decision);
    }


    public static String getAdventusMessageMapping(String decision){
        return GreenwichMappings.getMapping(messageMapping,decision);
    }
